...
// TODO: Update edges. Calculate distance between 2 nodes. Documentate code...
// fuck me

template <typename data> void debug(const std::vector<data> &array) {
...
template <typename Weight, typename BinaryOp> class heavy_light_decomposition {
